...
//@Controller
@RestController // @Controller + @ResponseBody : 해당 클래스의 메소드들은 모두 @ResponseBody가 적용된다.
@RequestMapping("/example/rest3") // 컨트롤러 클래스 매핑 : 해당 클래스의 메소드들의 공통 URL 정의한다.
public class RestController3 {
    //[1] HTTP GET
    // @RequestMapping(value="/example/rest3", method = RequestMethod.GET)
    @GetMapping("") // @GetMapping("HTTP URL정의") : HTTP GET 메소드의 URL 정의
