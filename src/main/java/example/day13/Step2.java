...
public class Step2 {
    public static void main(String[] args) {
        ...
        System.out.println("48보다 아래의 정수 = " + scores.lower(48));
        System.out.println("48보다 위의 정수 = " + scores.higher(48));
        System.out.println("48이거나 아래 정수 = " + scores.floor(48));
        System.out.println("45이거나 위 정수 = " + scores.ceiling(48));
        System.out.println("scores.descendingSet() = " + scores.descendingSet());
        System.out.println("48보다 이상 정수 = " + scores.tailSet(48, true)); // true = 이상, false : 초과
        System.out.println("48보다 이하 정수 = " + scores.headSet(48, true));
        System.out.println("10 이상이면서 48 미만 = " + scores.subSet(10, true, 48, false));
        // 6. TreeMap
        ...
        System.out.println("treeMap.tailMap(48, true) = " + treeMap.tailMap(48, true)); // true/false : 매개변수값도 포함하는지 여부
